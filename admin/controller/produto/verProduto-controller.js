        ...
        evento.preventDefault()
          const produto = evento.target.closest('[data-id]')
              ...
              listaProdutos.map (evento => {
                const criarElemento = criarVerProduto(evento.imageUrl, evento.nome, evento.valor, evento.descricao, evento.id, evento.categoria)      
...
const criarVerProduto = (imageUrl, nome, valor, descricao, id, categoria) =>  { 
